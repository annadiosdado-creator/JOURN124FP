...
## Introduction
I chose the City of Berkeley Business Licenses dataset. It shows that rental property and construction businesses make up the largest share of business licenses in the city. To better understand these patterns, I analyzed the dataset in Google Sheets using pivot tables and bar charts. I created four pivot tables and three bar charts to compare business types, ownership types, and the cities listed in the dataset. Based on my analysis, rental property, construction, and professional services appeared most often for business types, while sole ownership and corporation were the most common ownership types.
